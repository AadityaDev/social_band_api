...
module.exports = async (event, callback) => {
    ...
    const params = {
      TableName: 'bandgroup',
      Item: { data: data?.name, latitude: data?.latitude, longitude: data?.longitude, data: data?.description, 
        admin: data?.admin, participants: data?.participants, createdAt: data?.createdAt, updatedAt: data.updatedAt }
    };
